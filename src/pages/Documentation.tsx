      ...
      <header className="border-b bg-white">
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-primary">LodgeHub API Documentation</h1>
          ...
          <TabsContent value="overview" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-lg">
                  The LodgeHub API provides endpoints for agent authentication, room management, and file uploads.
