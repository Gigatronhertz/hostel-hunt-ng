...
const PAYMENT_MESSAGE = encodeURIComponent(
  "Hi! I'm ready to complete my payment as an agent on LodgeHub. Please assist me with the next steps."
);
      ...
      <Card className="max-w-md w-full shadow-xl border-0">
        ...
        <CardContent>
          <p className="mb-6 text-center text-lg text-muted-foreground">
            Thank you for choosing LodgeHub. To unlock all features and start listing your properties, please complete your agent payment.
          </p>
