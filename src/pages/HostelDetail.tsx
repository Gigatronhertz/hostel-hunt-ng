...
import { ArrowLeft, MapPin, Wifi, Zap, Droplets, Users, MessageSquare } from "lucide-react";
...
const HostelDetail = () => {
  ...
  // Sample hostel data (in a real app, this would come from an API)
  const hostelsData = {
    "1": {
      id: 1,
      name: "Unity Lodge",
      location: "Near University of Lagos",
      fullAddress: "23 Unity Road, Akoka, Lagos State",
      price: 45000,
      images: [
      ...
      rating: 4.8,
      description: "Unity Lodge offers modern accommodation for students at the University of Lagos. Our facility is designed with the student's comfort and academic success in mind. We provide a safe, clean, and conducive environment for learning and personal growth.",
      features: [
    ...
    "2": {
      ...
      fullAddress: "15 Academic Road, Bodija, Ibadan, Oyo State",
      price: 38000,
      images: [
        "https://images.unsplash.com/photo-1649972904349-6e44c42644a7?w=800&h=600&fit=crop",
  ...
  const handleSubmitMessage = (e: React.FormEvent) => {
    ...
    toast({
      title: "Message Sent!",
      description: "We'll contact you within 24 hours to schedule your inspection.",
    });
                ...
                {!showMessageForm ? (
                  <div className="space-y-4">
                    ...
                    <p className="text-sm text-muted-foreground text-center">
                      Contact us to schedule a physical inspection of this hostel.
                    </p>
                  </div>
                ) : (
